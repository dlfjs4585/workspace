...
public class Bank {
    ...
    public String Client(String accNumber, String name){
        for (int i = 0; i < clientList.size(); i++){
            if (name.equals(clientList.get(i).getName()) && accNumber.equals(clientList.get(i).getAccInfo().getAccNUmber())){
                clientList.get(i);
            }
        }
        return null;
    ...
    public String Balance(int balance){
        for (int i = 0; i < clientList.size(); i++){

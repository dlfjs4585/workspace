...
public class DataController {
    ...
    //form태그로 전달되는 데이터를 받을 때 매개변수를 사용한다.
    ...
    //매개변수로 전달된 클래스이 멤버변수명이 일치하면
    //html 에서 넘어온 데이터를 객체에 자동 저장시켜 줌.
    //이때 클래스는 반드시 getter, setter 생성되어야 함.
    //이렇게 html 에서 넘어온 데이터를 받기 위해 컨트롤러안의 메서드에서
    //매개변수로 활용하는 객체를 커멘드객체라고 지칭
    @PostMapping("/login1")
